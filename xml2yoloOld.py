...
# imgFolder = 'yolo_dir/img'
xmlFolder = 'yolo_dir/PlatePositionTraining/xmlPredict'
# imgFolder = 'yolo_dir/processing01'
imgFolder = 'yolo_dir/PlatePositionTraining/VideoImg'
#negFolder = "/home/chtseng/datasets/12_hand_gestures/negatives"
negFolder = ""
# saveYoloPath = 'yolo_dir/yolo_txt'
saveYoloPath = 'yolo_dir/PlatePositionTraining/xmlPredictTxt'
...
def transferYolo( xmlFilepath, imgFilepath):
    ...
    img_file, img_file_extension = os.path.splitext(imgFilepath) #分離檔名、副檔名
    print(img_file, img_file_extension)
