...
def convert2xml(imgfolderPath, savefolder, yolofolder, imgName, classArrray):
    ...
    fn, _ = os.path.splitext(imgName) #去除附檔名的filename
    ...
    dict01 = {'folder':imgfolder, 
          'filename':imgName, 
          'path':os.path.join(imgfolderPath, imgName)}
...
imgfolderPath = 'C:\\Users\\RaoBlack\\Documents\\YOC_YOLO\\img'
savefolder = 'xml2'
yolofolder = 'yoloTxt1'
